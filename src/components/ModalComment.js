...
export default function ModalComment({ commentInfo, deleteCommentMutate, updateCommentMutate, post_id }) {
    const { comment_id } = commentInfo;
    const [cookies] = useCookies(['accessToken']);
    console.log('modaldata', commentInfo);
    return (
        <div className="w-20 h-auto top-0 right-0 z-50 p-2 absolute rounded-2xl divide-y divide-gray_03 bg-white shadow-mainbox">
            ...
            <div
                onClick={() => deleteCommentMutate(post_id, comment_id, cookies)}

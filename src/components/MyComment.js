...
export default function CommentListCard({ post, comment, comment_id, category, post_id, user_id }) {
    const { like_num, scrap_num, user_type, comment_num, created_at } = post;

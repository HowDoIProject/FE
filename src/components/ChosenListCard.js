...
export default function ChosenListCard({ chosenCommentInfo }) {
    const { like_num, user_type, post_id, scrap_num, comment_num, created_at, title, comment, category } =
        chosenCommentInfo;

    console.log('chosencommentlistcard', chosenCommentInfo);
